...
<div class="page-header row">    
    ...
    <div class="span6 align-right"><a href="#" class="btn" onclick="galeriaJSForm.btnEditar_Click(<?php echo $galeria->getId(); ?>)"><i class="icon-remove-2"></i> Editar dados da galeria</a> <a href="#" onclick="_Biscoito.IrPara('administrador/galeria/adicionarfotos/<?php echo $galeria->getId() ?>')" class="btn btn-primary"><i class="icon-plus"></i> Adicionar mais fotos</a></div>
