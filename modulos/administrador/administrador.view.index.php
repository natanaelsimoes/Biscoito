...
<html>
    <head>
        ...
        <?php include_once('administrador.css.index.php'); ?>
    </head>
    <body>
        <header id="header">
            <hgroup>
        ...
        <section id="secondary_bar">
            ...
            <div class="breadcrumbs_container">
                <article class="breadcrumbs"><a href="<?php echo $GLOBALS['_Biscoito']->getSite() . 'administrador/'; ?>">Painel Administrativo</a> <div class="breadcrumb_divider"></div> <a class="current">Dashboard</a></article>
            </div>
